...
class BaseMathDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataroot, tokenizer, max_tokens, mode, mode_answer='default', len_multiplier=1.0, packing=None, randomize=None, pack_end=None, clean_numbers=False, latex_mask=False, peek_fraction=(0.1, 1.0),data_fraction=1.0):
